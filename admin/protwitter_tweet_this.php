...
<div class="wrap">
	<?php    echo "<h2>" . __( 'Pro Twitter - Tweet this', 'protwitter_tweet_this' ) . "</h2>"; ?>
	<form name="protwitter_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
		...
		<?php    echo "<h4>" . __( 'Display Settings', 'protwitter_tweet_this' ) . "</h4>"; ?>
		

		<p> You can add @'s and hashtags to "Tweet Text," i.e. "@Haotikus [TITLE] [URL] #plugins." </p>
		<p><?php _e("Tweet Text : " ); ?><input type="text" name="protwitter_tweet_this_tweet_text" value="<?php echo $protwitter_tweet_this_tweet_text; ?>" size="50"></p>

		<p><?php _e("Add Text after image : " ); ?><input type="text" name="protwitter_tweet_this_link_text" value="<?php echo $protwitter_tweet_this_link_text; ?>" size="20">
		<?php _e("Title : " ); ?><input type="text" name="protwitter_tweet_this_link_title" value="<?php echo $protwitter_tweet_this_link_title; ?>" size="20"></p>
	...
	<?php    echo "<h4>" . __( 'Advanced Options', 'protwitter_tweet_this' ) . "</h4>"; ?>
		...
		<p class="submit">
		<input type="submit" name="Submit" value="<?php _e('Update Options', 'protwitter_tweet_this' ) ?>" />
		</p>
	</form>
